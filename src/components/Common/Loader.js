...
import "./style.css";
import {AiFillTwitterCircle,AiOutlineWhatsApp,AiFillStar,AiFillLinkedin,AiFillCloseCircle,AiOutlineInstagram,AiOutlineArrowRight} from 'react-icons/ai';
                    ...
                    <div class="shop-pro-content">
                                    ...
                                    <div class="ec-product-inner">
                                        ...
                                        <div class="ec-pro-content">
                                            ...
                                            <div class="ec-pro-option">
                                              ...
                                              style={{"backgroundColor": "green"}}></span></a></li>
                                                    </ul>
                                                </div>
                                            ...
                                            <div class="ec-pro-option">
                                              ...
                                              style={{"backgroundColor": "green"}}></span></a></li>
                                                        <li><a href="#" class="ec-opt-clr-img"
                                                                ...
                                                                data-tooltip="Orange"><span></span></a></li>
                                                                        </ul>
                                                </div>
                                                <div class="ec-pro-size">
                                                    <span class="ec-pro-opt-label">Size</span>
                                                ...
                                                <div class="ec-pro-color">
                                                    ...
                                                    <ul class="ec-opt-swatch ec-change-img">
                                                        <li class="active"><a href="#" class="ec-opt-clr-img"
                                                                ...
                                                                data-tooltip="Gray"><span></span></a></li>
                                                                                                             <li><a href="#" class="ec-opt-clr-img"
                                                                ...
                                                                data-tooltip="Green"><span></span></a></li>
                                                                                                             <li><a href="#" class="ec-opt-clr-img"
                                                                data-src="assets/images/product-image/1_4.jpg"
                                                                data-src-hover="assets/images/product-image/1_4.jpg"
                                                                data-tooltip="Sky Blue"><span></span></a></li>
                                                                                                         </ul>
                                                </div>
                                                <div class="ec-pro-size">
                                                    <span class="ec-pro-opt-label">Size</span>
                        ...
                        <div class="ec-pro-pagination">
                            ...
                            <ul class="ec-pro-pagination-inner">
                                ...
                                <li><a href="#">4</a></li>
                                <li><a href="#">5</a></li>
                                <li><a class="next" href="#">Next <i ><AiOutlineArrowRight/></i></a></li>
                            </ul>
                        </div>
                        {/* <!-- Ec Pagination End --> */}
                    </div>
